function result = matchspectrA(msdata,matched_gpcomp,matched_gpmass,...
    matched_scanind,protbatch,FASTAbatch,triggerdata,protind,PTM,scoreoptions)
% MATCHSPECTRA: match experiment spectra against glycopeptides.
%
% Syntax:
...
if isHCDtrigger
    ...
    agpoptions.proceed_override = GlycoPATConstant.N_Proceed_Override;
    ...
    if doparallel
        ...
        spmd
            dist_tempresult = analyzegp(getLocalPart(dist_matched_gpcomp),...
