...
for i = 1:size(mspos,1)
    ...
    if strcmpi(mspara.shape{i},'flat hexagon') && strcmpi(mspara.color{i},'White') && ...
        ...
        text(fig,mspos(i,1),mspos(i,2),mspara.name{i}(1),'FontName','SansSerif','fontsize',options.fontsize*1.5,...
...
for i = 1:size(mspos,1)
    ...
    if options.showlink
        text(fig,typx,typy,char(double(linktyp)),'FontName','SansSerif','fontsize',options.linkfontsize,'horizontalalignment','center');
        text(fig,numx,numy,char(double(linknum)),'FontName','SansSerif','fontsize',options.linkfontsize,'horizontalalignment','center');
    end
        ...
        for j = 1:numel(breakpos)
            ...
            if strcmpi(breaktype{j},'NR')
                ...
                text(fig,typelineend(1)+  typetextfix(1),typelineend(2)+ typetextfix(2),...
                    char(double(breakinfo{j})),'FontName','SansSerif','horizontalalignment',alignment{1},...
            ...
            elseif strcmpi(breaktype{j},'R')
                ...
                text(fig,typelineend(1)-  typetextfix(1),typelineend(2)- typetextfix(2),...
                    char(double(breakinfo{j})),'FontName','SansSerif','horizontalalignment',alignment{2},...
                    'fontsize',options.fontsize);
                plot(fig,[linestart(1),lineend(1)],[linestart(2),lineend(2)],'k');
            elseif strcmpi(breaktype{j},'U')
                if msaddtextrot  % vertical glycan
                    text(fig,mspos(i,1) - options.monosacsize*1.02/2,mspos(i,2),...
                        char(double(breakinfo{j})),'FontName','SansSerif','horizontalalignment','center',...
                    ...
                    text(fig,mspos(i,1),mspos(i,2) + options.monosacsize*1.02/2,char(double(breakinfo{j})),...
                        'horizontalalignment','center','FontName','SansSerif',...
            ...
            elseif strcmpi(breaktype{j},'D_cb')
                if msaddtextrot  % vertical glycan
                    text(fig,mspos(i,1) + options.monosacsize*1.02/2,mspos(i,2),char(double(breakinfo{j})),...
                        'horizontalalignment','center','FontName','SansSerif',...
                        'verticalalignment','middle','fontsize',options.linkfontsize);
                else  % horizontal glycan
                    text(fig,mspos(i,1),mspos(i,2) - options.monosacsize*1.02/2,char(double(breakinfo{j})),...
                        'horizontalalignment','center','FontName','SansSerif',...
                        'verticalalignment','top','fontsize',options.linkfontsize);
                end
            elseif strcmpi(breaktype{j},'C')
                ...
                if strcmpi(options.centerfontweight,'n')
                    centerfontweight = 'normal';
                elseif strcmpi(options.centerfontweight,'normal')
                    centerfontweight = 'normal';
                elseif strcmpi(options.centerfontweight,'b')
                    centerfontweight = 'bold';
                elseif strcmpi(options.centerfontweight,'bold')
                    centerfontweight = 'bold';
                end
                text(fig,mspos(i,1),mspos(i,2)+ .02,char(double(breakinfo{j})),'horizontalalignment','center',...
                    'verticalalignment','middle','FontName','SansSerif',...
