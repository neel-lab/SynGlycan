...
%
% Input:
% mspos: n x 2 double. Monosaccharide position (not equalized).
% bondmap: n x n array of 0's and 1's, the linkage map of the glycan.
%
% Output:
% balmspos: n x 2 double, same size as input "mspos". Equalized
%     monosaccharide positions.
%
% Note:
