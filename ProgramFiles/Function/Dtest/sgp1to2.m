...
% SGP1TO2: convert SGP 1.0 format sequence to SGP 2.0 standard. This
%     function works for glycans and glycopeptides.
%
% Syntax:
% glysgp = sgp1to2(allsgp,mode)
%
% Input:
% allsgp: string. Glycan sequence in SGP 1.0 format
% PTMid: double. 1 means this sequence is a glycan, 0 means it is a
%     non-glycan PTM.
%
% Output:
