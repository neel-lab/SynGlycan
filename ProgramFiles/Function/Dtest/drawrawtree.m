...
%
% Input:
% bondmap: n x n double. Linkage map of glycan, n equals to the number
...
% distance: n x 1 double. The distance of the monosaccharide from
%     the first glycan in the sequence.
% skiplist: m x 1 double. Serial number of the monosaccharide(s) not to be
% included in the position calculation process.
%
% Output:
% monosacpos: n x 2 double. Calculated monosaccharide position.
%
% Note:
