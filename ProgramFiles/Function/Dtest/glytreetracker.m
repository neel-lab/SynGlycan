...
%
% Input:
% bondmap: n x n double. Linkage map of the glycan.
% start: double. Serial number where the tracking starts.
% stop: m x 1 double. The serial number(s) of the monosac.(s)
