...
%             plot(fig,vertexes(:,1),vertexes(:,2),'color',color,'linewidth',linewidth)
            patch(fig,vertexes(:,1),vertexes(:,2),fill,'edgecolor',[0,0,0],'linewidth',linewidth);
        end
...
%             plot(fig,[vertexes(:,1);vertexes(3,1)],[vertexes(:,2);vertexes(3,2)],'color',color,'linewidth',linewidth)
            patch(fig,vertexes(1:3,1),vertexes(1:3,2),fill,'edgecolor',[0,0,0],'LineWidth',linewidth);
            patch(fig,vertexes(3:5,1),vertexes(3:5,2),'white','edgecolor',[0,0,0],'LineWidth',linewidth);
        end
...
%             patch(fig,vertexes(1:4,1),vertexes(1:4,2),fill,'edgecolor',[1 1 1])
%             plot(fig,vertexes(:,1),vertexes(:,2),'color',color,'linewidth',linewidth)
            patch(fig,vertexes(1:4,1),vertexes(1:4,2),fill,'edgecolor',[0,0,0],'LineWidth',linewidth);
        end
...
%             plot(fig,[vertexes(:,1);vertexes(3,1)],[vertexes(:,2);vertexes(3,2)],'color',color,'linewidth',linewidth)
            patch(fig,vertexes(3:5,1),vertexes(3:5,2),fill,'edgecolor',[0,0,0],'LineWidth',linewidth);
            patch(fig,vertexes(1:3,1),vertexes(1:3,2),'white','edgecolor',[0,0,0],'LineWidth',linewidth);
        end
...
%             plot(fig,[vertexes(1,1),vertexes(3,1)],[vertexes(1,2),vertexes(3,2)],'color',color,'linewidth',linewidth)
            patch(fig,vertexes(1:3,1),vertexes(1:3,2),fill,'edgecolor',[0,0,0],'LineWidth',linewidth);
            patch(fig,vertexes([1,3,4],1),vertexes([1,3,4],2),'white','edgecolor',[0,0,0],'LineWidth',linewidth);
        end
...
%             patch(fig,vertexes(1:6,1),vertexes(1:6,2),fill,'edgecolor',[0,0,0],'LineWidth',linewidth);
%             plot(fig,[vertexes(:,1);vertexes(1,1)],[vertexes(:,2);vertexes(1,2)],'color',color,'linewidth',linewidth)
            patch(fig,vertexes(:,1),vertexes(:,2),fill,'edgecolor',[0,0,0],'LineWidth',linewidth);
        end
...
%             plot(fig,[vertexes(:,1);vertexes(1,1)],[vertexes(:,2);vertexes(1,2)],'color',color,'linewidth',linewidth)
    ...
    case 'CHAR'
        text(fig,origin(1),origin(2),name,'FontName','SansSerif','FontSize',options.fontsize*1.5,'FontWeight','bold','HorizontalAlignment','center','BackgroundColor','w','Margin',1)
    case 'ANOMER'
        switch upper(options.orientation)
            case {'UP','DOWN'}
                text(fig,origin(1),origin(2),name,'FontName','SansSerif','FontSize',options.fontsize*1.5,'FontWeight','bold','HorizontalAlignment','center','BackgroundColor','w','Margin',1)
            case 'LEFT'
                text(fig,origin(1),origin(2),name,'FontName','SansSerif','FontSize',options.fontsize*1.5,'FontWeight','bold','HorizontalAlignment','left','BackgroundColor','w','Margin',1)
            case 'RIGHT'
                text(fig,origin(1),origin(2),name,'FontName','SansSerif','FontSize',options.fontsize*1.5,'FontWeight','bold','HorizontalAlignment','right','BackgroundColor','w','Margin',1)
        end
end
end