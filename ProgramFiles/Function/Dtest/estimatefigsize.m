...
%
% Input:
% plotinfoout: m x n cell array. The plot information used in painting
%     program, 1st column contains the positioning info for each
%     monosaccharide in each glycan.
% peppos: 1 x n double. Position of each amino acid in the peptide
%     backbone. The numbers are the x position of amino acid. They will be
%     put at [x,-1] with "verticalalignment" set to "top".
