...
%     attached to each peptide fragment.
...
%
% Example:
% Run COMBITHEOFRAG and set breakpoints.
%
% Children function:
% N/A
...
if isstruct(pepfrag)
    for i = 1:length(pepfrag)
        ...
        thisptmtyp = ptmtype_f(thisinpepfragind_r);  % these numbers are sorted already
